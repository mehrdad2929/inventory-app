...
const createSQLTable = `CREATE TABLE IF NOT EXISTS inventory ( id INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY, name VARCHAR(50) UNIQUE, category_id INTEGER,  price DECIMAL(5, 2), src TEXT DEFAULT '/images/fork-knife-default.svg', description VARCHAR(200));`;
